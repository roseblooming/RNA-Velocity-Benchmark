...
class VAE(nn.Module):
    ...
    def __init__(self, observed = 2000, latent_dim = 20, zr_dim = 2, h_dim = 2,
        ...
        Parameters:
            observed: int, default=2000
                Number of genes.
            latent_dim: int, default=20
                Dimension of the latent space.
            zr_dim: int, default=2
                Dimension of the latent regulatory state.
            h_dim: int, default=2
                Dimension of the conditioning variable h.
            encoder_hidden: int, default=25
                Size of the encoder hidden layers.
            decoder_hidden: int, default=25
                Size of the decoder hidden layers.
            root_weight: float, default=0
                Optional weight to include a term in the loss to include a root cell.
            num_steps: int, default=100
                Number of ODE solver steps.
            encoder_bn: bool, default=False
                Whether to include batch normalization in the encoder.
            decoder_bn: bool, default=False
                Whether to include batch normalization in the decoder.
            likelihood_model: str, default='gaussian'
                Likelihood model to use ('gaussian' or 'negative-binomial').
            include_time: bool, default=False
                Whether to include time in the latent dynamics.
            kl_warmup_steps: int, default=25
                Number of warmup steps for KL annealing.
            kl_final_weight: float, default=1
                Final weight of the KL term in the loss.
            batch_correction: bool, default=False
                Whether to include batch correction.
            linear_decoder: bool, default=True
                Whether to use a linear decoder or an MLP decoder.
            linear_splicing: bool, default=True
                Whether to use linear splicing dynamics.
            use_velo_genes: bool, default=False
                Whether to restrict to velocity genes in the likelihood.
            correlation_reg: bool, default=True
                Whether to use correlation regularization on gene space.
            corr_weight_u: float, default=0.1
                Weight for correlation between velocity and unspliced RNA (u).
            corr_weight_s: float, default=0.1
                Weight for correlation between velocity and spliced RNA (-s).
            corr_weight_uu: float, default=0.0
                Weight for correlation between velocity and unspliced RNA (-u).
            batches: int, default=1
                Number of batches for batch correction.
            time_reg: bool, default=False
                Whether to include time correlation regularization.
            time_reg_weight: float, default=0.1
                Weight for time correlation regularization.
            time_reg_decay: float, default=0
                Decay factor for time regularization.
            shared: bool, default=False
                Whether to share encoder and decoder for spliced/unspliced RNA.
            corr_velo_mask: bool, default=True
                Whether to use velocity genes for correlation regularization.
            celltype_corr: bool, default=False
                Whether to use cell-type-specific correlation regularization.
            celltypes: int, default=0
                Number of cell types for cell-type-specific correlation regularization.
            exp_time: bool, default=False
                Whether to include experimental time in the encoder.
            max_sigma_z: float, default=0
                Maximum value for the latent sigma_z.
            latent_reg: bool, default=False
                Whether to impose an increasing relationship on the latent dynamics.
            velo_reg: bool, default=False
                Whether to directly regularize linear splicing velocity.
            velo_reg_weight: float, default=0.0001
                Weight for gene-space velocity regularization.
            celltype_velo: bool, default=False
                Whether to use cell-type-specific velocity regularization.
            gcn: bool, default=True
                Whether to use a graph convolutional network (GCN).
        """
